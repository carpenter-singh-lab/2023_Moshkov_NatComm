...
Thus, while cell health indicators likely contribute to the predictive morphological changes, they're probably not the whole story. A follow-up analysis comparing morphology-based models to models based on cell count alone could help tease apart the contributions of general toxicity versus more specific morphological effects, but with the caveat that "toxicity" itself may have very different implications across the diverse assay types in this dataset. The morphology-based models' strong performance likely reflects their ability to capture a wide range of biologically meaningful cellular changes beyond just cell death.
